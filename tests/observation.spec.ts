...
describe('Observation', () => {
  ...
  it('should return a sensible value for the J2000 default epoch', () => {
    ...
    expect(Polaris.ra).toBeCloseTo(38.19291823451926, 9)
    expect(Polaris.dec).toBeCloseTo(89.2669567810313, 9)
  })
  ...
  it('should be a reactive observable when the datetime changes', () => {
    ...
    expect(Polaris.ra).toBeCloseTo(44.09823947669144, 9)
    expect(Polaris.dec).toBeCloseTo(89.35165996685879, 9)
    expect(Polaris.ha).toBe(getApparentHourAngle(datetime, longitude, Polaris.ra))
  })
  ...
  it('should recompute the hour angle when the datetime changes', () => {
    ...
    expect(Polaris.ha).toBe(getApparentHourAngle(updated, longitude, Polaris.ra))
  })
})
