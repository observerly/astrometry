...
export const getCorrectionToEquatorialForAnnualAberration = (
  ...
  // The orbit of the Earth and the general precession in longitude are referred to Terrestrial Time, and so the
  // orbital terms and the precession are all resolved at the Terrestrial Time of the given date:
  ...
  const S = radians(getSolarTrueGeometricLongitude(tt) - pA)
