...
const getConstraintContext = (
  ...
  // Correct the target's equatorial coordinates to the epoch of date: the annual aberration
  // displaces the J2000 coordinate within the frame of J2000.0, the correction for the precession
  // of the equinoxes carries the displaced coordinate to its mean place of the date, and the
  // correction for the nutation, given that mean place, carries it to the true equator and
  // equinox of the date:
