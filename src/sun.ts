...
export const getBarycentricJulianDate = (datetime: Date, target: EquatorialCoordinate): number => {
  ...
  // The light travel time over that displacement, e.g., the interval by which the arrival of the
  // light at the barycenter follows its arrival at the observer (in days):
